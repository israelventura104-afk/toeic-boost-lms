...
**Paso 3b (Part 6 start):** Original Part 6 Text Completion — free intro (1 passage × 4 blanks), class bank Lotes 1–3 (12 passages × 4 = 48 validated Q toward ~80), free practice UI; guided/mock/strategies for Part 6 come next.
...
- Bank (guided + later mocks, class-validated): `data/part6-bank.json` — **Lotes 1–3:** 12 passages × 4 = **48** Q, IDs `TQB-P6-0001` … `0012` (**48 / 80**)
- Validation: `data/part6-validation-rubric.md` + `data/part6-bank-validation.json`
- Blueprint: `data/part6-blueprint.md`

Genres so far: **email**, **memo**, **notice**, **letter**, **ad**, **article**. Blank types (48): word_form 12 · vocabulary 12 · connector 12 · sentence_insertion 12.
