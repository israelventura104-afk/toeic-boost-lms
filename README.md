...
**Paso 3c (Part 7 Phase 1):** Original Part 7 Reading Comprehension — free intro (1 single × 3 Q), class bank **Lotes 1–4** (12 singles + 3 doubles + 1 triple = **67** validated Q), free practice UI live; guided/mock/strategies not built yet.
...
- Bank (guided + mocks later, class-validated): `data/part7-bank.json` — **Lotes 1–4:** 12 singles + 3 doubles + 1 triple = **67** Q, IDs `TQB-P7-0001` … `0016` (**67 / 100**)
...
Lote 4 added: **email** (MFA enrollment), **memo** (Q3 expense cutoff), **letter** (warehouse audit kickoff), **email + notice + form** (first **triple** — safety orientation). questionTypes (full bank): detail 20 · main_idea 10 · inference 14 · vocabulary 10 · not_except 8 · cross_reference 5.
...
| `data/part7-bank.json` | Class bank Lotes 1–4 (**67** validated — 12 singles + 3 doubles + 1 triple) |
| `data/part7-validation-rubric.md` | Teacher rubric (ES) for Part 7 class items |
| `data/part7-bank-validation.json` | Lotes 1–4 validation summary |
| `data/part7-blueprint.md` | ~100-Q target via lotes — Lotes 1–4 done (67/100) |
