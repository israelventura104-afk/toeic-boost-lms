...
**Paso 3:** Original Part 5 Incomplete Sentences bank (100 items total), free fixed practice (10), class guided practice (15), a real Reading hub, and a free Part 5 Strategies library.
...
| `part5-guided-practice.html` | **Yes** `TOEIC-VENTURA-2026` | 15 items from the 90-item bank, balanced by skill, session saved |
...
All 100 items are invented for this course. They are **not** copied from ETS, official TOEIC, or the TOEFL ITP bank.

- Intro (free, fixed, `shuffle: false`, `reuse_in_mocks: false`): `data/part5-intro.json` — 10 items, IDs `TQB-P5-0001` … `TQB-P5-0010`
- Bank (guided + later mocks, `exclude_from_free_intro: true`): `data/part5-bank.json` — 90 items, IDs `TQB-P5-0011` … `TQB-P5-0100`

Skill balance (100 total = 10 intro + 90 bank):

| Skill | Intro | Bank | Total |
|-------|------:|-----:|------:|
| Word Forms | 1 | 9 | 10 |
| Verb Tenses | 1 | 9 | 10 |
| Prepositions | 1 | 7 | 8 |
| Conjunctions/Transitions | 1 | 7 | 8 |
| Pronouns | 1 | 7 | 8 |
| Subject-Verb Agreement | 1 | 7 | 8 |
| Conditionals | 1 | 7 | 8 |
| Passive Voice | 1 | 7 | 8 |
| Comparatives/Superlatives | 1 | 7 | 8 |
| Gerunds/Infinitives | 1 | 7 | 8 |
| Articles/Determiners | 0 | 8 | 8 |
| Modals | 0 | 8 | 8 |
...
| `data/part5-bank.json` | Guided/mock bank (90) |
