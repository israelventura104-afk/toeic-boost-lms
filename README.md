...
**Paso 3:** Original Part 5 Incomplete Sentences bank (50 items total = 10 intro + 40 class-validated), free fixed practice (10), class guided practice (15), a real Reading hub, and a free Part 5 Strategies library.
...
| `part5-guided-practice.html` | **Yes** `TOEIC-VENTURA-2026` | 15 items from the 40-item class bank, balanced by skill, session saved |
...
All 50 items are invented for this course and the class bank is **rubric-validated**. They are **not** copied from ETS, official TOEIC, or the TOEFL ITP bank.

- Intro (free, fixed, `shuffle: false`, `reuse_in_mocks: false`): `data/part5-intro.json` — 10 items, IDs `TQB-P5-0001` … `TQB-P5-0010`
- Bank (guided + later mocks, class-validated, `exclude_from_free_intro: true`): `data/part5-bank.json` — **40** items, IDs `TQB-P5-0011` … `TQB-P5-0050`
- Validation: `data/part5-validation-rubric.md` + `data/part5-bank-validation.json`

Skill balance (50 total = 10 intro + 40 validated bank):
...
| Verb Tenses | 1 | 4 | 5 |
| Prepositions | 1 | 3 | 4 |
| Conjunctions/Transitions | 1 | 3 | 4 |
| Pronouns | 1 | 3 | 4 |
| Subject-Verb Agreement | 1 | 4 | 5 |
| Conditionals | 1 | 3 | 4 |
| Passive Voice | 1 | 3 | 4 |
| Comparatives/Superlatives | 1 | 3 | 4 |
| Gerunds/Infinitives | 1 | 4 | 5 |
| Articles/Determiners | 0 | 3 | 3 |
| Modals | 0 | 3 | 3 |
...
| `data/part5-bank.json` | Guided/mock class bank (40 validated) |
| `data/part5-validation-rubric.md` | Teacher rubric (ES) for Part 5 class items |
| `data/part5-bank-validation.json` | Validation summary (kept/rewritten/dropped) |
